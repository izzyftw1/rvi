-- Harden auto_generate_work_orders: remove NEW.alloy; use per-line fields from items JSON
...
BEGIN
  ...
  IF (TG_OP = 'INSERT' AND NEW.status = 'approved') OR 
    ...
    -- Loop through each item in the sales order JSON (legacy compatibility)
