...
import { UserPlus, Edit, Trash2, CheckCircle2, XCircle, Loader2 } from "lucide-react";
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            {roles.map((role) => (
                              <SelectItem 
                                key={role.id} 
                                value={role.role_name || 'unassigned'}
                              >
        ...
        <DialogContent className="max-w-md">
          ...
          <form onSubmit={handleCreateUser} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={newUser.role || (roles.length > 0 ? roles[0].role_name : "")}
