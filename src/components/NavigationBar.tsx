...
export const NavigationBar = ({ userRoles }: NavigationBarProps) => {
  ...
  const navGroups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        { label: "Quality Overview", path: "/quality", icon: ClipboardCheck },
        { label: "Material QC (Incoming)", path: "/qc/incoming", icon: ClipboardCheck },
        { label: "In-Process QC (Hourly)", path: "/hourly-qc", icon: ClipboardCheck },
        { label: "Final QC", path: "/final-qc", icon: ClipboardCheck },
        { label: "NCR Management", path: "/ncr", icon: ClipboardCheck },
        { label: "Traceability", path: "/quality/traceability", icon: ClipboardCheck },
        { label: "Quality Documents", path: "/quality/documents", icon: ClipboardCheck },
        { label: "Quality Analytics", path: "/quality/analytics", icon: ClipboardCheck },
