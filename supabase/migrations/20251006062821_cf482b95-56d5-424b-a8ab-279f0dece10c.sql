-- Update auto_generate_work_orders to set a valid initial stage
...
BEGIN
  ...
  IF (TG_OP = 'INSERT' AND NEW.status = 'approved') OR 
    ...
    LOOP
      ...
      new_wo_id := NEW.so_id || '-WO-' || LPAD(wo_counter::text, '0', 3);
      ...
      INSERT INTO public.work_orders (
        ...
        (item_record->>'due_date')::date,
        COALESCE((item_record->>'priority')::integer, 3),
        NEW.id,
        'pending',
        'goods_in', -- valid wo_stage
